CREATE TABLE SALESPEOPLE (SNUM INT(5),SNAME VARCHAR(20),CITY VARCHAR(10), COMM INT(5));
...
INSERT INTO SALESPEOPLE VALUES (1004,'FRAN','LONDON',26);
INSERT INTO SALESPEOPLE VALUES (1005,'RIKKLIN','BARCELONA',21);

CREATE TABLE CUSTOMER (CNUM INT(5) PRIMARY KEY,CNAME VARCHAR(20), CITY VARCHAR(20),SNUM INT(10), RATING INT(10), FOREIGN KEY (SNUM) REFERENCES SALESPEOPLE(SNUM));
...
CREATE TABLE ORDERS (ONUM INT(5),AMT DECIMAL(8,2),SNUM INT(5),CNUM INT(5),ODATE DATE);

ALTER TABLE ORDERS ADD FOREIGN KEY (SNUM) REFERENCES SALESPEOPLE(SNUM) ;
ALTER TABLE ORDERS ADD FOREIGN KEY (CNUM) REFERENCES CUSTOMER(CNUM) ;
